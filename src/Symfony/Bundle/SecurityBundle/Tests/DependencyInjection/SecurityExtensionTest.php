...
class SecurityExtensionTest extends TestCase
{
    ...
    public function testOidcLoginVerifiesTheIdTokenSignature()
    {
        ...
        $this->assertSame('security.authenticator.oidc_login.signature_verifier.main', (string) $container->getDefinition('security.authenticator.oidc_login.main')->getArgument(11));
    }
    ...
    public function testOidcLoginCanSkipTheIdTokenSignatureVerification()
    {
        ...
        $this->assertNull($container->getDefinition('security.authenticator.oidc_login.main')->getArgument(11));
    }
